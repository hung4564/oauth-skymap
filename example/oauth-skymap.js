...
var AuthProfile = /** @class */ (function () {
    ...
    AuthProfile.prototype.logOut = function (access_token) {
        return __awaiter(this, void 0, void 0, function () {
            var url, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthProfile.prototype.validateToken = function (scopes) {
        return __awaiter(this, void 0, void 0, function () {
            var access_token, url, params, query, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        access_token = this.getToken();
...
var AuthorizationCodePKCEGrant = /** @class */ (function (_super) {
    __extends(AuthorizationCodePKCEGrant, _super);
    function AuthorizationCodePKCEGrant() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AuthorizationCodePKCEGrant.prototype.handleResponse = function (response) {
        var tokenRequest = {
    ...
    AuthorizationCodePKCEGrant.prototype.canHandleResponse = function (response) {
        return response.hasOwnProperty("code");
    };
    AuthorizationCodePKCEGrant.prototype.getloginUrl = function () {
    ...
    AuthorizationCodePKCEGrant.prototype.canHandleRequest = function (config) {
...
var encodeQS$1 = function (params) {
    var res = "";
    var k, i = 0;
    for (k in params) {
        res += (i++ === 0 ? "" : "&") + encodeURIComponent(k) + "=" + encodeURIComponent(params[k]);
...
var Oauth = /** @class */ (function () {
    ...
    Oauth.prototype.setDefaultGrant = function () {
        this.grants.push(new AuthorizationCodePKCEGrant(this.store, this.providerUrl));
...
export { defaultOauthOption, AuthorizationCodePKCEGrant, AGrant };
